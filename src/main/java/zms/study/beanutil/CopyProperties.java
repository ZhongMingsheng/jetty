...
public class CopyProperties {
	...
	public void testClassLoader(){
		//sun.misc.Launcher$AppClassLoader@2c7b84de
		//sun.misc.Launcher$AppClassLoader@2c7b84de
		Thread thread = null;
		for (int i = 0; i < 5; i++) {
			thread = new Thread();
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * copy before A [time=zhong, age=null] B [time=null, age=18, sex=男]
		 * copy after A [time=zhong, age=null] B [time=zhong, age=null, sex=男]
		 */
		org.springframework.beans.BeanUtils.copyProperties(a, b);// copy a to b
																	// success
